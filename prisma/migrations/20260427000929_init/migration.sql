...
CREATE TABLE "Caravan" (
    ...
    "length" DOUBLE PRECISION NOT NULL DEFAULT 6.0,
...
-- CreateIndex
CREATE INDEX "Caravan_deletedAt_idx" ON "Caravan"("deletedAt");

-- CreateIndex
CREATE INDEX "Bed_caravanId_idx" ON "Bed"("caravanId");

-- CreateIndex
CREATE INDEX "Guest_lastName_firstName_idx" ON "Guest"("lastName", "firstName");

-- CreateIndex
CREATE INDEX "Booking_bedId_date_idx" ON "Booking"("bedId", "date");
...
-- AddForeignKey
ALTER TABLE "Bed" ADD CONSTRAINT "Bed_caravanId_fkey" FOREIGN KEY ("caravanId") REFERENCES "Caravan"("id") ON DELETE CASCADE ON UPDATE CASCADE;
